    ...
    for C, COND in enumerate(CONDS):
        ...
        for f, file in enumerate(files):
            ...
            for ch, ch_name in enumerate(channel_names):
                if ch==0:
                    data = data_csv["SOX2"]
                    SOX2[T][C].append(data)
                    SOX2_all[T][C] = [*SOX2_all[T][C], *data]
                elif ch==1:
                    data = data_csv["OCT4"]
                    OCT4[T][C].append(data)
                    OCT4_all[T][C] = [*OCT4_all[T][C], *data]
                elif ch==2:
                    data = data_csv["BRA"]
                    BRA[T][C].append(data)
                    BRA_all[T][C] = [*BRA_all[T][C], *data]
                elif ch==3:
                    data = data_csv["DAPI"]
...
SOX2_cleaned_48h_0 = remove_outliers(np.array(SOX2_all[0][0]))
SOX2_cleaned_48h_1 = remove_outliers(np.array(SOX2_all[0][1]))

OCT4_cleaned_48h_0 = remove_outliers(np.array(OCT4_all[0][0]))
OCT4_cleaned_48h_1 = remove_outliers(np.array(OCT4_all[0][1]))

BRA_cleaned_48h_0 = remove_outliers(np.array(BRA_all[0][0]))
BRA_cleaned_48h_1 = remove_outliers(np.array(BRA_all[0][1]))
...
SOX2_cleaned_60h_0 = remove_outliers(np.array(SOX2_all[1][0]))
SOX2_cleaned_60h_1 = remove_outliers(np.array(SOX2_all[1][1]))
SOX2_cleaned_60h_2 = remove_outliers(np.array(SOX2_all[1][2]))

OCT4_cleaned_60h_0 = remove_outliers(np.array(OCT4_all[1][0]))
OCT4_cleaned_60h_1 = remove_outliers(np.array(OCT4_all[1][1]))
OCT4_cleaned_60h_2 = remove_outliers(np.array(OCT4_all[1][2]))

BRA_cleaned_60h_0 = remove_outliers(np.array(BRA_all[1][0]))
BRA_cleaned_60h_1 = remove_outliers(np.array(BRA_all[1][1]))
BRA_cleaned_60h_2 = remove_outliers(np.array(BRA_all[1][2]))
...
SOX2_cleaned_72h_0 = remove_outliers(np.array(SOX2_all[2][0]))
SOX2_cleaned_72h_1 = remove_outliers(np.array(SOX2_all[2][1]))
SOX2_cleaned_72h_2 = remove_outliers(np.array(SOX2_all[2][2]))

OCT4_cleaned_72h_0 = remove_outliers(np.array(OCT4_all[2][0]))
OCT4_cleaned_72h_1 = remove_outliers(np.array(OCT4_all[2][1]))
OCT4_cleaned_72h_2 = remove_outliers(np.array(OCT4_all[2][2]))

BRA_cleaned_72h_0 = remove_outliers(np.array(BRA_all[2][0]))
BRA_cleaned_72h_1 = remove_outliers(np.array(BRA_all[2][1]))
BRA_cleaned_72h_2 = remove_outliers(np.array(BRA_all[2][2]))
...
SOX2_cleaned_84h_0 = remove_outliers(np.array(SOX2_all[3][0]))
SOX2_cleaned_84h_1 = remove_outliers(np.array(SOX2_all[3][1]))
SOX2_cleaned_84h_2 = remove_outliers(np.array(SOX2_all[3][2]))

OCT4_cleaned_84h_0 = remove_outliers(np.array(OCT4_all[3][0]))
OCT4_cleaned_84h_1 = remove_outliers(np.array(OCT4_all[3][1]))
OCT4_cleaned_84h_2 = remove_outliers(np.array(OCT4_all[3][2]))

BRA_cleaned_84h_0 = remove_outliers(np.array(BRA_all[3][0]))
BRA_cleaned_84h_1 = remove_outliers(np.array(BRA_all[3][1]))
BRA_cleaned_84h_2 = remove_outliers(np.array(BRA_all[3][2]))
...
SOX2_cleaned_96h_0 = remove_outliers(np.array(SOX2_all[4][0]))
SOX2_cleaned_96h_1 = remove_outliers(np.array(SOX2_all[4][1]))
SOX2_cleaned_96h_2 = remove_outliers(np.array(SOX2_all[4][2]))

OCT4_cleaned_96h_0 = remove_outliers(np.array(OCT4_all[4][0]))
OCT4_cleaned_96h_1 = remove_outliers(np.array(OCT4_all[4][1]))
OCT4_cleaned_96h_2 = remove_outliers(np.array(OCT4_all[4][2]))

BRA_cleaned_96h_0 = remove_outliers(np.array(BRA_all[4][0]))
BRA_cleaned_96h_1 = remove_outliers(np.array(BRA_all[4][1]))
BRA_cleaned_96h_2 = remove_outliers(np.array(BRA_all[4][2]))
